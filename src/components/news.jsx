...
import { useGetCryptosNewsQuery } from '../Service/cryptoNewsApi';
            ...
            <Card hoverable className="news-card">
              <a href={news.url} target="_blank" rel= "noreferrer">
                <div className="news-image-container">
                  ...
                  <img style={{maxWidth:'100px', maxHeight:'100px'}} src={news?.image?.thumbnail?.contenUrl || demoImage}/>
                </div>
                <p>
                ...
                <div className="provider-container">
                  <div>
                    <Avatar src={news.provider[0]?.image?.thumbnail?.contenUrl || demoImage}></Avatar>
